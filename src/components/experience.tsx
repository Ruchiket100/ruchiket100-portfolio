			...
			<div className="flex flex-col p-4 gap-6">
				{entries.map((entry, entryIdx) => (
					<div key={entryIdx}>
						...
						<div className="pt-3">
							<div className="flex flex-col gap-3 relative before:absolute before:left-3 before:w-[1px] before:h-full before:bg-border">
								{entry.roles.map((role, roleIdx) => (
									<div key={roleIdx} className="flex flex-col gap-3">
										<div className="flex gap-2">
											<div className="p-1 z-10 bg-background aspect-square border border-border">
												{roleIdx === 0 ? (
													<svg
														width="16px"
														height="16px"
